...
func (m *CliManager) Switch(info *iwechat.Account, history string) error {
...
func (m *CliManager) StartService() error {
...
func (m *CliManager) StopService() error {
	if err := m.stopService(); err != nil {
		return err
	}
...
func (m *CliManager) SetHTTPAddr(text string) error {
	var addr string
...
func (m *CliManager) StartAutoDecrypt() error {
...
func (m *CliManager) StopAutoDecrypt() error {
...
func (m *CliManager) CommandKey(configPath string, pid int, force bool, showXorKey bool) (string, error) {
...
func (m *CliManager) CommandHTTPServer(configPath string, cmdConf map[string]any) error {
...
func (m *CliManager) Decrypt(configPath string, cmdConf map[string]any) error {
